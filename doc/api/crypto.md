...
* `'rsa'`[^openssl30] (OID 1.2.840.113549.1.1.1) RSA Secret Value Encapsulation
* `'ec'`[^openssl32] (OID 1.2.840.10045.2.1)
  * `'P-256'` (OID 1.2.840.10045.3.1.7) DHKEM(P-256, HKDF-SHA256)
  * `'P-384'` (OID 1.3.132.0.34) DHKEM(P-384, HKDF-SHA256)
  * `'P-521'` (OID 1.3.132.0.35) DHKEM(P-521, HKDF-SHA256)
* `'x25519'`[^openssl32] (OID 1.3.101.110) DHKEM(X25519, HKDF-SHA256)
* `'x448'`[^openssl32] (OID 1.3.101.111) DHKEM(X448, HKDF-SHA512)
* `'ml-kem-512'`[^openssl35] (OID 2.16.840.1.101.3.4.4.1) ML-KEM
* `'ml-kem-768'`[^openssl35] (OID 2.16.840.1.101.3.4.4.2) ML-KEM
* `'ml-kem-1024'`[^openssl35] (OID 2.16.840.1.101.3.4.4.3) ML-KEM
