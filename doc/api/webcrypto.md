...
| Algorithm                            | `generateKey` | `exportKey` | `importKey` | `encrypt/decrypt` | `wrapKey/unwrapKey` | `deriveBits/deriveKey` | `sign/verify` | `digest` | `getPublicKey` | `'\(en\|de\)capsulate\(Bits\|Keys\)'` |
| ------------------------------------ | ------------- | ----------- | ----------- | ----------------- | ------------------- | ---------------------- | ------------- | -------- | -------------- | ------------------------------------- |
| `'AES-CBC'`                          | ✔             | ✔           | ✔           | ✔                 | ✔                   |                        |               |          |                |                                       |
| `'AES-CTR'`                          | ✔             | ✔           | ✔           | ✔                 | ✔                   |                        |               |          |                |                                       |
| `'AES-GCM'`                          | ✔             | ✔           | ✔           | ✔                 | ✔                   |                        |               |          |                |                                       |
...
* `'encapsulateBits'` - The key may be used to encapsulate bits.
* `'decapsulateBits'` - The key may be used to decapsulate bits.
* `'encapsulateKey'` - The key may be used to encapsulate a new key.
* `'decapsulateKey'` - The key may be used to decapsulate a new key.
...
| Supported Key Algorithm              | `'encrypt/decrypt'` | `'sign/verify'` | `'deriveKey/deriveBits'` | `'wrapKey/unwrapKey'` | `'\(en\|de\)capsulate\(Bits\|Keys\)'` |
| ------------------------------------ | ------------------- | --------------- | ------------------------ | --------------------- | ------------------------------------- |
| `'AES-CBC'`                          | ✔                   |                 |                          | ✔                     |                                       |
| `'AES-CTR'`                          | ✔                   |                 |                          | ✔                     |                                       |
| `'AES-GCM'`                          | ✔                   |                 |                          | ✔                     |                                       |
