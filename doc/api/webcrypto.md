...
[^secure-curves]: > Stability: 1.2 - Release candidate, see [Secure Curves in the Web Cryptography API][]

[^modern-algos]: > Stability: 1.1 - Active development, see [Modern Algorithms in the Web Cryptography API][]
