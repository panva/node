...
// optional secondary KeyObject handle for hybrid keys, and optional opaque
// key data) lives
...
//            -> Object.prototype
//
// All native internal slots are read from C++ in a single call via
...
// Algorithm,Usages,Handle,SecondaryHandle,Data}` helpers index into that
...
/**
 * Returns the optional secondary KeyObjectHandle wrapping a hybrid
...
/**
 * Returns the optional opaque data stored with a CryptoKey.
 * @param {CryptoKey} key
 * @returns {Buffer | undefined}
 */
function getCryptoKeyData(key) {
  return getSlots(key)[kSlotData];
}
