...
function asyncAesKwCipher(mode, key, data) {
  return new AESCipherJob(
    ...
    getCryptoKeyHandle(key),
    data,
    getVariant('AES-KW', getCryptoKeyAlgorithm(key).length)).run();
}
