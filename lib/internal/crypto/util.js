...
// EdDSA prehash (Ed25519ph/Ed448ph) requires OpenSSL >= 3.2
let { 0: opensslMajor, 1: opensslMinor } = process.versions.openssl.split('.');
opensslMajor = NumberParseInt(opensslMajor, 10);
opensslMinor = NumberParseInt(opensslMinor, 10);
const hasEddsaPrehash = opensslMajor > 3 ||
  (opensslMajor === 3 && opensslMinor >= 2);
...
const kAlgorithmDefinitions = {
  ...
  'ECDSA': {
    ...
    'sign': 'EcdsaParams',
    'verify': 'EcdsaParams',
    'signDigest': 'EcdsaParams',
    'verifyDigest': 'EcdsaParams',
  },
  'Ed25519': {
    'generateKey': null,
    'exportKey': null,
    ...
    'verify': null,
    ...hasEddsaPrehash ? {
      'signDigest': 'ContextParams',
      'verifyDigest': 'ContextParams',
    } : {},
  },
  'Ed448': {
    'generateKey': null,
  ...
  'RSA-PSS': {
    ...
    'sign': 'RsaPssParams',
    'verify': 'RsaPssParams',
    'signDigest': 'RsaPssParams',
    'verifyDigest': 'RsaPssParams',
  },
  'RSASSA-PKCS1-v1_5': {
    'generateKey': 'RsaHashedKeyGenParams',
    'exportKey': null,
