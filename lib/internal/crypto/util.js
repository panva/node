...
// Algorithms this build has no implementation for at all, which are dropped
// from the registry below so that they do not normalize for any operation.
// Every entry must be a property of the build, not of the running process.
