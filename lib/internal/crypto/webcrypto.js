  ...
  switch (algorithm.name) {
    ...
    case 'MLKEM1024-P384':
      ...
      result = await require('internal/crypto/mlkem_x25519')
        .mlKemHybridGenerateKey(algorithm, extractable, keyUsages);
      break;
    case 'KMAC128':
      // Fall through
    case 'KMAC256':
  ...
  switch (getCryptoKeyAlgorithm(key).name) {
    ...
    case 'MLKEM1024-P384': {
      ...
      return require('internal/crypto/mlkem_x25519')
        .mlKemHybridExportKey(key, format);
    }
    default:
      return undefined;
  }
...
async function exportKeyRawSeed(key) {
  switch (getCryptoKeyAlgorithm(key).name) {
    ...
    case 'MLKEM1024-P384':
      return require('internal/crypto/mlkem_x25519')
        .mlKemHybridExportKey(key, 'raw-seed');
    default:
      return undefined;
  }
}
  ...
  switch (algorithm.name) {
    ...
    case 'MLKEM1024-P384':
      result = require('internal/crypto/mlkem_x25519')
        .mlKemHybridImportKey(format, keyData, algorithm, extractable, keyUsages);
      break;
  }
...
async function getPublicKey(key, keyUsages) {
  ...
  switch (getCryptoKeyAlgorithm(key).name) {
    ...
    case 'MLKEM1024-P384':
      return require('internal/crypto/mlkem_x25519')
        .mlKemHybridGetPublicKey(key, keyUsages);
  }
  ...
  switch (keyAlgorithm.name) {
    ...
    case 'MLKEM1024-P384':
      return await require('internal/crypto/mlkem_x25519')
        .mlKemHybridEncapsulate(encapsulationKey);
  }
...
async function decapsulateBits(decapsulationAlgorithm, decapsulationKey, ciphertext) {
  ...
  switch (keyAlgorithm.name) {
    ...
    case 'MLKEM1024-P384':
      return await require('internal/crypto/mlkem_x25519')
        .mlKemHybridDecapsulate(decapsulationKey, ciphertext);
  }
