...
bool ReadRsaPssParams(const EVP_PKEY* pkey, Rsa::PssParams* params) {
  ...
  // A digest parameter is absent when it holds the SHA-1 default, which is
  // what PssParams was initialized with. An unresolvable name is left at that
  // default rather than discarding the whole sequence.
  char name[80];
